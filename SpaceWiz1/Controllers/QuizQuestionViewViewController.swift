...
class QuizQuestionViewController: UIViewController {
    ...
    func setupConstraints() {
           ...
           NSLayoutConstraint.activate([
               buttonsContainerView.topAnchor.constraint(equalTo: earthImageView.bottomAnchor, constant: 185),
           ...
           for (index, button) in answerButtons.enumerated() {
               NSLayoutConstraint.activate([
                   button.topAnchor.constraint(equalTo: buttonsContainerView.topAnchor, constant: CGFloat(50 * index)),
